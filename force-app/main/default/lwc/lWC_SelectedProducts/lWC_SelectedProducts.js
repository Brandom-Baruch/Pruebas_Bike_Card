...
import getProducts from '@salesforce/apex/APX_SelectedProducts.getProducts';
...
export default class LWC_SelectedProducts extends LightningElement {
    @track value;
    @track error;
    @track data;
    ...
    nextHandler() {
        console.log('Entrando: '+ this.allSelectedRows);
        this.isPageChanged = true;
